...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                <h2>Formulaire d'ajout d'une saison</h2>
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" action="ajouter-saisons.php" method="post" accept="image/*" enctype="multipart/form-data" >
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">URL de la saison <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="url" class="form-control col-md-7 col-xs-12" data-validate-length-range="2" data-validate-words="1" name="url" placeholder=""  type="text">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Mot clé  de la saison <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
