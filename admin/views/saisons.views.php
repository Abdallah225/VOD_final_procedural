    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Saisons <small>La liste des saisons</small></h3>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td><?php echo $saison['description']?></td>
                        ...
                        <td><?php echo $saison['date_post']?></td>
                        <td><?php echo $saison['mot_cle']?></td>
                        <td><?php echo $saison['url']?></td>
                        <td>
                            <form action="edition-saisons.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $saison['id'];?>">
                            <a href="edition-saisons.php?id=<?php echo $saison['id'];?> & name=<?php echo $saison['libelle'];?>"  name="modifier" class="btn btn-warning">
