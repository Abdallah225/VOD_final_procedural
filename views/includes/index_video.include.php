...
<?php if($row_count != 0):?>
  ...
  <div class="titre">
      <h2>Ici c'est babi de Charly KODJO</h2>
  </div> 
  <div class="row">
  <?php
        ...
        <div class="card1-image"><!-- card1 image -->
          ...
          <img class="img-fluid overlayImage" src="data:..asset/images/jpg;base64,<?php echo $image?>" alt="Responsive image" srcset="">
            ...
            <div class="card1-content action-v-<?php echo $episode['id'] ?>">
              ...
              <button type="button" onclick="window.location.href='login.php'" class="btn btn-primary btn-lg">REGARDER &nbsp<i class="fas fa-play"></i></button>                   
            </div><!-- card1 content -->
          </div>
        </div>
      </div>
