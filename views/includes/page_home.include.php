  ...
  <div class=" h-100">
    <div class="d-flex h-100">
      <div class="w-100 text-white">
            ...
            <button type="button" id="watch" onclick="window.location.href='playeur?id=<?php echo $episode['id'];?> & name=<?php echo $episode['url'];?>'" class="btn btn-primary btn-lg mt-4">REGARDER &nbsp<i class="fas fa-play"></i></button>
      </div>
    </div>
    <?php } ?>
    <?php endif?>
