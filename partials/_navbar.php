    ...
    <input id="search" class="btn btn-outline-dark my-2 my-sm-0" type="text" placeholder="Que recherchez vous ?"> 
      ...
      <ul class="navbar-nav ml-auto">
        <?php 
                ...
                echo "<a class='nav-link active' href='page.php'>Acceuil";
                echo "<span class='sr-only'>(current)</span>";
                echo "</a>";
                echo "</li>";
                echo "<li class='nav-item'>";
                echo "<a class='nav-link' href='explorer.php'>Explorer</a>";
                echo "</li>";
                echo "<li class='nav-item'>";
                echo "<a class='nav-link' href='profile.php'><i class='fas fa-user-circle ico'></i></a>";
                echo "</li>";
                echo "<li class='nav-item'>";
                ...
                // echo "</li>";
                echo "<li class='nav-item'>";
                echo "<a class='nav-link' href='php/logout.php'><i class='fas fa-sign-out-alt'></i></a>";
                echo "</li>";
							}
							else
							{
